...
<script>
  ...
  const questions = [
    ...
    { text: "p,qและr เป็น เท็จ จริง และ เท็จ ตามลำดับ จงหาค่าความจริงของ ~q↔(p∨r)", answer: "เท็จ" },
    ...
    { text: "pและq เป็น เท็จ และ เท็จ ตามลำดับ จงหาค่าความจริงของ p↔~q", answer: "จริง" },
    ...
    { text: "p,qและr เป็น จริง เท็จ และ เท็จ ตามลำดับ จงหาค่าความจริงของ ~(p∨r)↔q", answer: "เท็จ" },
    ...
    { text: "p,qและr เป็น จริง จริง และ เท็จ ตามลำดับ จงหาค่าความจริงของ ~q→(p↔r)", answer: "เท็จ" },
  ];
